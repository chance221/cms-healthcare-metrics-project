    ...
    Statement = [
      {
        ...
        "Condition": {
            "StringEquals": {
                ...
                "token.actions.githubusercontent.com:sub": "repo:chance221@39056884/cms-healthcare-metrics-project@137165760:pull_request"
            }
        }
      }
    ]
    ...
    Statement = [
      {
        ...
        "Condition": {
            "StringEquals": {
                "token.actions.githubusercontent.com:aud": "sts.amazonaws.com",
                "token.actions.githubusercontent.com:sub": "repo:chance221@39056884/cms-healthcare-metrics-project@137165760:environment:production"
            }
        }
      }
    ]
